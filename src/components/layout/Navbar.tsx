    ...
    groups: [
      {
        heading: "By Goal",
        items: [
          { label: "Generate More Creatives", href: "/generate-more-creatives" },
          { label: "Launch Ads Faster", href: "/launch-ads-faster" },
          { label: "Scale Ads Automatically", href: "/scale-ads-automatically" },
        ],
      },
      {
        heading: "By Industry",
